...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 575119737, ; hash 0x2247a179, from name: libaot-ahorcado
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 600007282, ; hash 0x23c36272, from name: ahorcado.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 61
	...
	%struct.DSOCacheEntry {
		i64 754611510, ; hash 0x2cfa7536, from name: aot-ahorcado
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 73
	...
	%struct.DSOCacheEntry {
		i64 1773944512, ; hash 0x69bc3ec0, from name: ahorcado
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 188
	...
	%struct.DSOCacheEntry {
		i64 3529156473, ; hash 0xd25aa779, from name: aot-ahorcado.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 396
	...
	%struct.DSOCacheEntry {
		i64 4249977716, ; hash 0xfd518374, from name: libaot-ahorcado.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 474
