...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 4789026329637532681, ; hash 0x42760a12ce09b409, from name: ahorcado.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 117
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7192300145271084550, ; hash 0x63d02ee02cdf9606, from name: ahorcado
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 161
	...
	%struct.DSOCacheEntry {
		i64 11695648828690584147, ; hash 0xa24f4aa4bbd0d253, from name: libaot-ahorcado
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 297
	...
	%struct.DSOCacheEntry {
		i64 13745748742317044089, ; hash 0xbec2b5a72d947179, from name: aot-ahorcado.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
	...
	%struct.DSOCacheEntry {
		i64 13942032415804473637, ; hash 0xc17c0c9d3701c125, from name: aot-ahorcado
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 364
	...
	%struct.DSOCacheEntry {
		i64 15078368523950858186, ; hash 0xd1412048ae859fca, from name: libaot-ahorcado.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-ahorcado.dll.so
		ptr null; void* handle (0x0)
	}, ; 394
...
@.env.3 = private unnamed_addr constant [37 x i8] c"0f886eb3-36a4-409d-8a62-9db0cfe5191a\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.ahorcado\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [23 x i8] c"libaot-ahorcado.dll.so\00", align 16
